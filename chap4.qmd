...
Now, let's transition our focus from hardware to the software, exploring the vital elements that drive the functionality of computer systems.

[@pc-hardware-beginners-guide]

## Software

Software used to be in a rudimentary format, primarily designed for specific numerical calculations or other simple data processing tasks. To execute calculations, switches and circuits were manually set. However, as computers grew smarter and transitioned from a hardware-centric approach came the provision of the software. 
...
Additionally, there are also programming paradigms that are overarching styles of how tasks can be structured and executed. Common paradigms include:
